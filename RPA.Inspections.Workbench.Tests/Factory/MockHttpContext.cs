...
namespace RPA.Inspections.Workbench.Tests.Factory
{
    public static class MockHttpContext
    {
        public static HttpContextBase GetMockedHttpContext()
        {
            ...
            RPA.Inspections.Workbench.RouteConfig.RegisterRoutes(routes);
            ...
            user.Setup(ctx => ctx.IsInRole("Quality Checks: OC Team Member")).Returns(true);
