...
namespace RPA.Inspections.Workbench.Services.SheetModels
{
    public class LateCattleCalculator
    {
        ...
        public LateCattleCalculator(IHolidayService holidayService)
        {
            this.holidayService = holidayService;
        }

        public LateCattleCount Calculator(Cattle cattle, LateCattleCount lateCattleCount, IHolidayService holidayService)
        {
